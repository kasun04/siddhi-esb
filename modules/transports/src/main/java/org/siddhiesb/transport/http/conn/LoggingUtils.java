...
import org.siddhiesb.transport.http.conn.LoggingNHttpClientConnection;
import org.siddhiesb.transport.http.conn.LoggingNHttpClientHandler;
import org.siddhiesb.transport.http.conn.LoggingNHttpServerConnection;
import org.siddhiesb.transport.http.conn.LoggingNHttpServiceHandler;

public class LoggingUtils {

    public final static String HEADER_LOG_ID = "org.siddhiesb.transport.http.headers";
    public final static String WIRE_LOG_ID = "org.siddhiesb.transport.http.wire";
    public final static String ACCESS_LOG_ID = "org.siddhiesb.transport.http.access";
