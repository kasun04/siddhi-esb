...
public class SourceContext {
    ...
    private org.siddhiesb.transport.passthru.ProtocolState state = org.siddhiesb.transport.passthru.ProtocolState.REQUEST_READY;
    ...
    public void reset() {
        this.request = null;
        this.response = null;
        this.state = org.siddhiesb.transport.passthru.ProtocolState.REQUEST_READY;
