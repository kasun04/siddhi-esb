...
public class ServerConnFactory {
    ...
    private final org.siddhiesb.transport.http.conn.SSLContextDetails ssl;
    private final Map<InetSocketAddress, org.siddhiesb.transport.http.conn.SSLContextDetails> sslByIPMap;
    ...
    public ServerConnFactory(
        ...
        this.ssl = ssl;
        this.sslByIPMap = sslByIPMap != null ? new ConcurrentHashMap<InetSocketAddress, org.siddhiesb.transport.http.conn.SSLContextDetails>(
            sslByIPMap) : null;
