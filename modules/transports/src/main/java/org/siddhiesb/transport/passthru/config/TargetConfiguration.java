...
import org.siddhiesb.transport.http.conn.ProxyAuthenticator;
 ...
 */
public class TargetConfiguration extends org.siddhiesb.transport.passthru.config.BaseConfiguration {
    ...
    public TargetConfiguration(WorkerPool workerPool,
