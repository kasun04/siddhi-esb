...
import org.siddhiesb.transport.passthru.workerpool.WaterMarkQueue;
 ...
 */
public class NativeWorkerPool implements org.siddhiesb.transport.passthru.workerpool.WorkerPool {
    ...
    public NativeWorkerPool(int core, int max, int keepAlive,
        ...
        executor = new PassThruThreadPoolExecutor(core, max, keepAlive, TimeUnit.SECONDS,
                                               blockingQueue,
    ...
    public NativeWorkerPool(int core, int max, int keepAlive,
        ...
        executor = new PassThruThreadPoolExecutor(
                core, max, keepAlive,
                TimeUnit.SECONDS,
                blockingQueue,
    ...
    public NativeWorkerPool(int core, int max, int keepAlive,
                            int queueLength, int waterMark, String threadGroupName,
                            String threadGroupId, org.siddhiesb.transport.passthru.workerpool.WaterMarkQueue<Runnable> queue) {
