 ...
 * from the {@link java.util.concurrent.ThreadPoolExecutor}. In this executor after all the core pool threads
 ...
 * is a bounded queue and the queue is completely filled a {@link java.util.concurrent.RejectedExecutionHandler}
...
public class WaterMarkExecutor extends ThreadPoolExecutor {
    public WaterMarkExecutor(int core, int max, long keepAlive,
                             TimeUnit timeUnit, org.siddhiesb.transport.passthru.workerpool.WaterMarkQueue<Runnable> queue) {
