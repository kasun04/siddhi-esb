...
public class TargetConnections {
    ...
    private final Map<HttpRoute, org.siddhiesb.transport.passthru.connections.HostConnections> poolMap =
            new ConcurrentHashMap<HttpRoute, org.siddhiesb.transport.passthru.connections.HostConnections>();
    ...
    public void shutdownConnection(NHttpClientConnection conn) {
        org.siddhiesb.transport.passthru.connections.HostConnections pool = (org.siddhiesb.transport.passthru.connections.HostConnections) conn.getContext().getAttribute(
