...
public class ConnectCallback implements SessionRequestCallback {
    ...
    public void timeout(SessionRequest request) {
        ...
        deliveryAgent.errorConnecting(pool.getRoute(),
                org.siddhiesb.transport.passthru.ErrorCodes.CONNECT_TIMEOUT, "Connection Timeout");
    ...
    public void cancelled(SessionRequest request) {
        ...
        deliveryAgent.errorConnecting(pool.getRoute(),
                org.siddhiesb.transport.passthru.ErrorCodes.CONNECT_CANCEL, "Connection Cancel");
