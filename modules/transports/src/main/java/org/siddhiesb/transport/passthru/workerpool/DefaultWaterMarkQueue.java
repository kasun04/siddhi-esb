 ...
 * {@link java.util.concurrent.ArrayBlockingQueue} up to water mark. Then it uses a {@link java.util.concurrent.LinkedBlockingQueue} or
 ...
 * @param <T>
 */
public class DefaultWaterMarkQueue<T> implements org.siddhiesb.transport.passthru.workerpool.WaterMarkQueue<T> {
    ...
    /**
     * Create a {@link org.siddhiesb.transport.passthru.workerpool.WaterMarkQueue} with a waterMark. The queue will first fill up
     * to waterMark. These items will be inserted in to an {@link java.util.concurrent.ArrayBlockingQueue}.
     * After this an {@link java.util.concurrent.LinkedBlockingQueue} will be used without a bound.
     *
     ...
     * Create a {@link org.siddhiesb.transport.passthru.workerpool.WaterMarkQueue} with a waterMark. The queue will first fill up
     * to waterMark. These items will be inserted in to an {@link java.util.concurrent.ArrayBlockingQueue}.
     * After this an {@link java.util.concurrent.LinkedBlockingQueue} will be used with capacity
